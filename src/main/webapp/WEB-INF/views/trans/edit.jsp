...
<body class="gray-bg">
            ...
            <div class="ibox-content">
            	<form class="form-horizontal m-t" id="RepositoryTransForm">
            		...
            		<div class="form-group">
                    	...
                    	<div class="col-sm-7">
                    		<select id="transRepositoryId" name="transRepositoryId" class="form-control" 
           		 	...
           		 	<div class="form-group">
	                    <label class="col-sm-3 control-label required">转换路径：</label>
	                    <div class="col-sm-7">
	                        <input id="transPath" name="transPath" type="text" readOnly class="form-control" aria-required="true">
	                    </div>
	                </div>
					<div class="form-group">
	...
	<script src="static/js/my/trans-edit.js"></script>   
</body>
</html>