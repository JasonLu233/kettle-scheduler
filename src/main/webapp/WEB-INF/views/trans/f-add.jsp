...
<body class="gray-bg">
            ...
            <div class="ibox-content">
            	<form class="form-horizontal m-t" id="RepositorytransForm">           
	                <div class="form-group">
	                    <label class="col-sm-3 control-label">转换：</label>
	                    <div class="col-sm-7">
							<input id="transFile" name="transFile" type="file">
	                    </div>
	                </div>     
	                <div class="form-group">
	                    <label class="col-sm-3 control-label">转换名称：</label>
	                    <div class="col-sm-7">
	                ...
	                <div class="form-group">
            			<label class="col-sm-3 control-label">记录日志级别：</label>
                    	<div class="col-sm-7">
	                ...
	                <input type="hidden" id="transPath" name="transPath">
                 	<input type="hidden" id="transType" name="transType" value="2" >       
	                <div class="form-group">
	...
	<script src="static/js/my/f-trans-add.js"></script>   
</body>
</html>