		...
		<div class="ibox-content">
			<form class="form-horizontal m-t" id="CategoryForm">
				...
				<div class="form-group">
					<label class="col-sm-3 control-label">任务分类名称：</label>
					<div class="col-sm-7">
    ...
    $().ready(function () {
        ...
        $("#CategoryForm").validate({
            rules: {
                categoryName: {
                    ...
                    remote:{
                        ...
                        data: {categoryId: function () { return $("#categoryId").val(); },
            ...
            submitHandler: function (form) {
                $.post("category/update.shtml", decodeURIComponent($(form).serialize(), true), function (data) {
