...
<body class="gray-bg">
        ...
        <div class="ibox float-e-margins">
            ...
            <div class="ibox-content">
            	<form class="form-horizontal m-t" id="RepositoryForm">     
            		<input id="repositoryId" name="repositoryId" value="${repositoryId }" type="hidden">       		             
	                ...
	                <div class="form-group">
	                    <div class="col-sm-9 col-sm-offset-3">
	                    	...
	                    	<button class="btn btn-w-m btn-primary" type="button" onclick="reset()"><i class="fa fa-check" aria-hidden="true"></i>&nbsp;重置</button>
	...
	<script src="static/js/my/repository-edit.js"></script>   
</body>
</html>