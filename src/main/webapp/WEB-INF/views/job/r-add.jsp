            ...
            <div class="ibox-content">
            	<form class="form-horizontal m-t" id="RepositoryJobForm">
            		<div class="form-group">
                    	...
                    	<div class="col-sm-7">
                    		<select id="jobRepositoryId" name="jobRepositoryId" class="form-control" aria-required="true">
	                            <option value="" selected>请选择资源库</option>
	                        </select>
	                    </div>
            		</div>            		
	                <div class="form-group">
	                    <label class="col-sm-3 control-label required">作业：</label>
	                    <div class="col-sm-7">
	                        <input id="jobPath" readonly name="jobPath" type="text" placeholder="请选择作业" class="form-control" aria-required="true">
	                    </div>
	                </div>
					<div class="form-group">
