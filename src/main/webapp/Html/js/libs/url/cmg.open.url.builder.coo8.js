...
function Coo8RESTAPI(treeMap){
	this.ht = treeMap;
}

Coo8RESTAPI.prototype.put = function (key, value) {
		this.ht.put(key, value);
}

Coo8RESTAPI.prototype.encrypt = function (app_secret) {
...
Coo8RESTAPI.prototype.URLEncode = function (ru, rp) {
	var request_url = ru;
