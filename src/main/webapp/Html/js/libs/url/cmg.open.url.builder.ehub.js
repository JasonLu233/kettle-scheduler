...
function EHubRESTAPI(treeMap){
	this.ht = treeMap;
}

EHubRESTAPI.prototype.put = function (key, value) {
		this.ht.put(key, value);
}

EHubRESTAPI.prototype.encrypt = function (app_secret) {
...
EHubRESTAPI.prototype.URLEncode = function (ru, rp) {
	var request_url = ru;
