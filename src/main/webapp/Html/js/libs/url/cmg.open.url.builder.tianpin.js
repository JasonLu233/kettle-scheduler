...
function TianpinRESTAPI(treeMap){
	this.ht = treeMap;
}

TianpinRESTAPI.prototype.put = function (key, value) {
		this.ht.put(key, value);
}

TianpinRESTAPI.prototype.encrypt = function (app_secret) {
...
TianpinRESTAPI.prototype.URLEncode = function (ru, rp) {
	var request_url = ru;
